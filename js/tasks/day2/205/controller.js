...
(function (ISPApp) {
    ...
    (function (Controllers) {
        "use strict";
        var Task205Controller = (function () {
            function Task205Controller($scope, $timeout, dataService) {
                var _this = this;
                this.$scope = $scope;
            ...
            Task205Controller.prototype.randomiseItems = function () {
            ...
            Task205Controller.prototype.activateTask = function (handle) {
                var _this = this;
            ...
            Task205Controller.prototype.clickEarA = function () {
                var audio = new Audio(this.itemA['audio']);
                audio.play();
            };
            Task205Controller.prototype.clickEarB = function () {
                var audio = new Audio(this.itemB['audio']);
                audio.play();
            };
            Task205Controller.prototype.clickItemA = function () {
                var _this = this;
            ...
            Task205Controller.prototype.clickItemB = function () {
                var _this = this;
            ...
            Task205Controller.prototype.clickForwardArrow = function () {
                var _this = this;
                this.opacity = 0;
                this.round++;
                this.itemA.highlight = false;
            ...
            Task205Controller.$inject = ['$scope', '$timeout', 'DataService'];
            return Task205Controller;
        })();
        Controllers.Task205Controller = Task205Controller;
