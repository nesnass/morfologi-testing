...
(function (ISPApp) {
    ...
    (function (Controllers) {
        "use strict";
        var TaskC102Controller = (function () {
            function TaskC102Controller($scope, $timeout, dataService) {
                var _this = this;
                this.$scope = $scope;
            ...
            TaskC102Controller.prototype.introduction = function () {
                var _this = this;
                var audioFile = '';
                this.round++;
                this.setupImages();
            ...
            TaskC102Controller.prototype.setupImages = function () {
                var vGap = 10, hGap = 10;
                for (var n = 1; n < 4; n++) {
            ...
            TaskC102Controller.prototype.enlargeImages = function () {
                var vGap = 10, hGap = 10;
            ...
            TaskC102Controller.prototype.driveOnPageOneCompleted = function () {
                var _this = this;
            ...
            TaskC102Controller.prototype.driveOffPageThreeCompleted = function () {
                this.$scope['wpC'].taskFinished();
            };
            TaskC102Controller.clickImage = function (filename) {
                new Audio(filename).play();
            };
            TaskC102Controller.prototype.closeVan = function () {
                var _this = this;
                this.$timeout(function () {
            ...
            TaskC102Controller.$inject = ['$scope', '$timeout', 'DataService'];
            return TaskC102Controller;
        }());
        Controllers.TaskC102Controller = TaskC102Controller;
